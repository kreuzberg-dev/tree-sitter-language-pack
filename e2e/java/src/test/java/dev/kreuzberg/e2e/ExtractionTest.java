...
class ExtractionTest {
    ...
    void testValidateEmptyPatterns() throws Exception {
        ...
        var result = TreeSitterLanguagePack.validate_extraction("{\"language\":\"python\",\"patterns\":{}}");
    ...
    void testValidateExtractionInvalidQuery() throws Exception {
        ...
        assertThrows(Exception.class, () -> TreeSitterLanguagePack.validate_extraction("{\"language\":\"python\",\"patterns\":{\"broken\":{\"capture_output\":\"Full\",\"query\":\"(this_is_not_a_valid_node @x\"}}}"));
    }

    @Test
    void testValidateExtractionValidConfig() throws Exception {
        // Valid extraction config passes validation
        var result = TreeSitterLanguagePack.validate_extraction("{\"language\":\"python\",\"patterns\":{\"functions\":{\"capture_output\":\"Full\",\"query\":\"(function_definition name: (identifier) @name)\"}}}");
        assertEquals(true, result.valid());
    }
