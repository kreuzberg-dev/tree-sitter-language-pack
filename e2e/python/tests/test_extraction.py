...
# alef:hash:698a07058ef9554688d1f1e98cbfda5772fabd3b1c91b49930bd0bbe2cbcfa0e
...
def test_extract_invalid_byte_range() -> None:
    ...
    config = {
        ...
        "patterns": {
            "funcs": {
                "byte_range": [9999, 99999],
                "capture_output": "Full",
                "query": "(expression_statement) @e",
            }
        },
    }
...
def test_validate_extraction_invalid_query() -> None:
    ...
    config = {
        ...
        "patterns": {
            "broken": {
                "capture_output": "Full",
                "query": "(this_is_not_a_valid_node @x",
            }
        },
    }
