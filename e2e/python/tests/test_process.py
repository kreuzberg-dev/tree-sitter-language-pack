...
# alef:hash:39ce0373dd09a579ede691de47be8058a649b55e9cec22fcb46460cb06ea6b33
...
def test_c_function_process() -> None:
    ...
    assert any("Function" in str(_e.structure[0].kind) for _e in (result.structure or []))  # noqa: S101
...
def test_java_class_process() -> None:
    ...
    assert len(result.structure) >= 1  # noqa: S101
    assert any("Class" in str(_e.structure[0].kind) for _e in (result.structure or []))  # noqa: S101
    assert len(result.imports) >= 1  # noqa: S101
    assert result.metrics.total_lines >= 7  # noqa: S101
    assert result.metrics.error_count == 0  # noqa: S101
...
def test_java_package_declaration_process() -> None:
    ...
    assert any("Module" in str(_e.structure[0].kind) for _e in (result.structure or []))  # noqa: S101
    assert any("Class" in str(_e.structure[0].kind) for _e in (result.structure or []))  # noqa: S101
    assert result.metrics.error_count == 0  # noqa: S101
...
def test_process_python_imports_detail() -> None:
    ...
    assert result.language == "python"  # noqa: S101
    assert len(result.imports) >= 2  # noqa: S101
    assert any("os" in str(_e.imports[0].source) for _e in (result.imports or []))  # noqa: S101
