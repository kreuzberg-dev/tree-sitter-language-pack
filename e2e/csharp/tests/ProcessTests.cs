...
// alef:hash:9724853e745e03b65a82d3cf16a1daa1b36a1f4a255ec760ccc0d7beb5409e59
...
namespace TreeSitterLanguagePack
{
    ...
    public class ProcessTests
    {
        ...
        public void Test_CFunctionProcess()
        {
            ...
            Assert.True(result.Structure?.Any(e767d0b15 => Convert.ToString(e767d0b15.Kind)!.Contains("Function")) == true, "element of 'structure[].kind': Function");
        ...
        public void Test_JavaClassProcess()
        {
            ...
            Assert.True(result.Structure.Count >= 1, "expected at least 1 elements");
            Assert.True(result.Structure?.Any(ee876d34e => Convert.ToString(ee876d34e.Kind)!.Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Imports.Count >= 1, "expected at least 1 elements");
            Assert.True(result.Metrics.TotalLines >= 7, "expected >= 7");
            Assert.True(result.Metrics.ErrorCount == 0);
        ...
        public void Test_JavaPackageDeclarationProcess()
        {
            ...
            Assert.True(result.Structure?.Any(e66a77f4c => Convert.ToString(e66a77f4c.Kind)!.Contains("Module")) == true, "element of 'structure[].kind': Module");
            Assert.True(result.Structure?.Any(ee876d34e => Convert.ToString(ee876d34e.Kind)!.Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Metrics.ErrorCount == 0);
