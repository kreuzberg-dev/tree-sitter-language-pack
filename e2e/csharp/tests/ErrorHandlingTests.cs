...
// alef:hash:290c0aed1a50fc4e47a6a8ed13f887c17f86712882e060604312e19ae6392049
...
namespace TreeSitterLanguagePack
{
    ...
    public class ErrorHandlingTests
    {
        ...
        [Fact]    public void Test_ErrorDetectContentEmpty()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_ErrorDetectExtensionEmpty()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_ErrorDetectPathEmpty()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_ErrorHandlingEmptySource()
        {
        ...
        [Fact]    public void Test_ErrorHandlingHaskellUnterminatedBlockComment()
        {
        ...
        [Fact]    public void Test_ErrorHandlingInvalidSyntax()
        {
        ...
        [Fact]    public void Test_ErrorProcessEmptySource()
        {
