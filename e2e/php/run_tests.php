...
// alef:hash:f2b23342dde95b64483fecb73a8315023068f91acca56bb6002287a465cfb788
...
$localExtPath = __DIR__ . '/../../target/release/libts_pack_core_php' . $extSuffix;
...
if ($loadedVersion !== '1.16.2') {
    ...
    fwrite(STDERR, "  expected version: 1.16.2\n");
