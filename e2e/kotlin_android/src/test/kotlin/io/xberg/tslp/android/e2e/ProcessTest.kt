...
// alef:hash:6cf01da5fb81d5e3f51eb8bd1f9ccf7cc0355e56c425ebfdd1c817e5d5ac6c3f
...
class ProcessTest {
    ...
    @Test
    fun testCFunctionProcess(): Unit = runBlocking {
        ...
        assertEquals("c", result.language)
        assertTrue(result.structure.size >= 1, "expected at least 1 elements")
        assertTrue(result.structure.any { e -> e.kind.toString().contains("Function") }, "expected to contain: " + "Function")
        assertTrue(result.metrics.totalLines >= 6, "expected >= 6")
        assertEquals(0, result.metrics.errorCount)
    }

    @Test
    fun testConfigAllPython(): Unit = runBlocking {
    ...
    @Test
    fun testConfigMinimalPython(): Unit = runBlocking {
    ...
    @Test
    fun testGoFunctionProcess(): Unit = runBlocking {
    ...
    @Test
    fun testGoFunctionProcessDetail(): Unit = runBlocking {
        // Intel: extract structure from Go function definition
        val config = MAPPER.readValue("{\"language\":\"go\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("package main\n\nimport \"fmt\"\n\nfunc main() {\n\tfmt.Println(\"hello\")\n}\n", config)
        assertEquals("go", result.language)
    ...
    @Test
    fun testJavaClassProcess(): Unit = runBlocking {
        ...
        assertTrue(result.structure.size >= 1, "expected at least 1 elements")
        assertTrue(result.structure.any { e -> e.kind.toString().contains("Class") }, "expected to contain: " + "Class")
        assertTrue(result.imports.size >= 1, "expected at least 1 elements")
        assertTrue(result.metrics.totalLines >= 7, "expected >= 7")
        assertEquals(0, result.metrics.errorCount)
    }
    ...
    @Test
    fun testJavaPackageDeclarationProcess(): Unit = runBlocking {
        ...
        assertTrue(result.structure.any { e -> e.kind.toString().contains("Module") }, "expected to contain: " + "Module")
        assertTrue(result.structure.any { e -> e.kind.toString().contains("Class") }, "expected to contain: " + "Class")
        assertEquals(0, result.metrics.errorCount)
    }

    @Test
    fun testJavascriptMultiImportProcess(): Unit = runBlocking {
    ...
    @Test
    fun testJavascriptMultiImportProcessDetail(): Unit = runBlocking {
        // Intel: detect multiple imports and function in JavaScript
        val config = MAPPER.readValue("{\"language\":\"javascript\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("import fs from 'fs';\nimport path from 'path';\n\nfunction process(input) {\n    return input.trim();\n}\n", config)
        assertEquals("javascript", result.language)
    ...
    @Test
    fun testKotlinPackageClassProcess(): Unit = runBlocking {
    ...
    @Test
    fun testProcessJavascriptExportsCount(): Unit = runBlocking {
    ...
    @Test
    fun testProcessJavascriptExportsDetail(): Unit = runBlocking {
    ...
    @Test
    fun testProcessPythonAllFeatures(): Unit = runBlocking {
    ...
    @Test
    fun testProcessPythonComments(): Unit = runBlocking {
    ...
    @Test
    fun testProcessPythonDocstrings(): Unit = runBlocking {
    ...
    @Test
    fun testProcessPythonImportsDetail(): Unit = runBlocking {
        // Python with multiple imports, verify imports contain specific source
        val config = MAPPER.readValue("{\"language\":\"python\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("import os\nimport sys\nfrom pathlib import Path\n\ndef main():\n    pass\n", config)
        assertEquals("python", result.language)
        assertTrue(result.imports.size >= 2, "expected at least 2 elements")
        assertTrue(result.imports.any { e -> e.source.toString().contains("os") }, "expected to contain: " + "os")
    }

    @Test
    fun testProcessPythonMetricsDetail(): Unit = runBlocking {
    ...
    @Test
    fun testProcessPythonSymbols(): Unit = runBlocking {
    ...
    @Test
    fun testProcessRustStructureName(): Unit = runBlocking {
    ...
    @Test
    fun testPythonChunkingMedium(): Unit = runBlocking {
    ...
    @Test
    fun testPythonChunkingProcessDetail(): Unit = runBlocking {
    ...
    @Test
    fun testPythonClassWithMethodsProcess(): Unit = runBlocking {
    ...
    @Test
    fun testPythonClassWithMethodsProcessDetail(): Unit = runBlocking {
        // Intel: extract nested structure from Python class with methods
        val config = MAPPER.readValue("{\"language\":\"python\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("class Calculator:\n    def add(self, a, b):\n        return a + b\n\n    def subtract(self, a, b):\n        return a - b\n", config)
        assertEquals("python", result.language)
    ...
    @Test
    fun testPythonErrorDiagnostics(): Unit = runBlocking {
    ...
    @Test
    fun testPythonFunctionProcess(): Unit = runBlocking {
    ...
    @Test
    fun testPythonFunctionProcessDetail(): Unit = runBlocking {
        // Intel: extract structure from Python function definition
        val config = MAPPER.readValue("{\"language\":\"python\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("def greet(name):\n    return f'Hello, {name}!'\n", config)
        assertEquals("python", result.language)
    ...
    @Test
    fun testPythonMalformedCodeProcess(): Unit = runBlocking {
    ...
    @Test
    fun testPythonMalformedCodeProcessDetail(): Unit = runBlocking {
        // Intel: detect diagnostics in malformed Python code
        val config = MAPPER.readValue("{\"diagnostics\":true,\"language\":\"python\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("def broken(\n    return\nclass", config)
        assertEquals("python", result.language)
    ...
    @Test
    fun testPythonMultiImportProcess(): Unit = runBlocking {
    ...
    @Test
    fun testPythonMultiImportProcessDetail(): Unit = runBlocking {
        // Intel: detect multiple Python imports
        val config = MAPPER.readValue("{\"language\":\"python\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("import os\nimport sys\nfrom pathlib import Path\n\ndef main():\n    pass\n", config)
        assertEquals("python", result.language)
    ...
    @Test
    fun testRubyClassProcess(): Unit = runBlocking {
    ...
    @Test
    fun testRustChunkingProcess(): Unit = runBlocking {
    ...
    @Test
    fun testRustChunkingProcessDetail(): Unit = runBlocking {
        // Intel: chunk multi-function Rust source into pieces
        val config = MAPPER.readValue("{\"chunk_max_size\":30,\"language\":\"rust\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("fn alpha() {}\n\nfn beta() {}\n\nfn gamma() {}\n\nfn delta() {}\n", config)
        assertEquals("rust", result.language)
    ...
    @Test
    fun testRustFunctionProcess(): Unit = runBlocking {
    ...
    @Test
    fun testRustFunctionProcessDetail(): Unit = runBlocking {
        // Intel: extract structure from Rust function definition
        val config = MAPPER.readValue("{\"language\":\"rust\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("fn add(a: i32, b: i32) -> i32 {\n    a + b\n}\n", config)
        assertEquals("rust", result.language)
    ...
    @Test
    fun testTypescriptFunctionProcess(): Unit = runBlocking {
    ...
    @Test
    fun testTypescriptFunctionProcessDetail(): Unit = runBlocking {
        // Intel: extract structure from TypeScript function
        val config = MAPPER.readValue("{\"language\":\"typescript\"}", ProcessConfig::class.java)
        val result = TreeSitterLanguagePack.process("import { readFile } from 'fs';\n\nfunction greet(name: string): string {\n    return `Hello, \${name}!`;\n}\n", config)
        assertEquals("typescript", result.language)
