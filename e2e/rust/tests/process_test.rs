...
// alef:hash:7251bd4a8bf2bee1a243ad9431056d738dac7bd279b55fa0067196e519819732
...
"#;
    ...
    assert!(
        result
            .structure
            .iter()
            .any(|e| format!("{:?}", e.kind).contains(r#"Function"#)),
...
"#;
    ...
    assert!(
        result
            .structure
            .iter()
            .any(|e| format!("{:?}", e.kind).contains(r#"Class"#)),
        "expected some element of structure[].kind to contain: {}",
        r#"Class"#
    );
    assert!(!result.imports.is_empty(), "expected >= 1");
...
"#;
    ...
    assert!(
        result
            .structure
            .iter()
            .any(|e| format!("{:?}", e.kind).contains(r#"Module"#)),
        "expected some element of structure[].kind to contain: {}",
        r#"Module"#
    );
    assert!(
...
"#;
    ...
    assert!(
        result.imports.iter().any(|e| e.source.to_string().contains(r#"os"#)),
