...
"#;
    ...
    assert!(result.exports.len() >= 2, "expected at least 2 elements, got {}", result.exports.len());
}
...
"#;
    ...
    assert!(result.structure.len() >= 2, "expected at least 2 elements, got {}", result.structure.len());
