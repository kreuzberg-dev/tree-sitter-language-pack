...
"#;
    ...
    assert!(
        result.structure.contains(r#"Function"#),
        "expected to contain: {}",
        r#"Function"#
    );
...
"#;
    ...
    assert!(!result.structure.is_empty(), "expected >= 1");
    assert!(
        result.structure.contains(r#"Class"#),
        "expected to contain: {}",
        r#"Class"#
    );
    assert!(!result.imports.is_empty(), "expected >= 1");
...
"#;
    ...
    assert!(
        result.structure.contains(r#"Module"#),
        "expected to contain: {}",
        r#"Module"#
    );
    assert!(
...
"#;
    ...
    assert!(result.imports.contains(r#"os"#), "expected to contain: {}", r#"os"#);
}
...
"#;
    ...
    assert!(!result.structure.is_empty(), "expected >= 1");
    assert!(
        result.structure.contains(r#"MyConfig"#),
        "expected to contain: {}",
        r#"MyConfig"#
    );
}
