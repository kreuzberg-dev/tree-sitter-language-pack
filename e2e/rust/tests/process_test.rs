...
// alef:hash:f30d901cc65f28a74886ae699dd3741b2aba46d5c2d6fdab4a268c3744a46c10
    ...
    assert!(
        result
            ...
            .any(|item| serde_json::to_value(item).ok().is_some_and(|value| match value {
                serde_json::Value::String(text) => text == r#"Function"#,
                serde_json::Value::Object(fields) => fields
                    .get("name")
                    .and_then(serde_json::Value::as_str)
                    .is_some_and(|text| text == r#"Function"#),
                _ => false,
            })),
...
"#;
    ...
    assert!(
        result
            ...
            .iter()
            .any(|item| serde_json::to_value(item).ok().is_some_and(|value| match value {
                serde_json::Value::String(text) => text == r#"Class"#,
                serde_json::Value::Object(fields) => fields
                    .get("name")
                    .and_then(serde_json::Value::as_str)
                    .is_some_and(|text| text == r#"Class"#),
                _ => false,
            })),
        "expected collection item name: {}",
        r#"Class"#
...
"#;
    ...
    assert!(
        result
            ...
            .iter()
            .any(|item| serde_json::to_value(item).ok().is_some_and(|value| match value {
                serde_json::Value::String(text) => text == r#"Module"#,
                serde_json::Value::Object(fields) => fields
                    .get("name")
                    .and_then(serde_json::Value::as_str)
                    .is_some_and(|text| text == r#"Module"#),
                _ => false,
            })),
        "expected collection item name: {}",
        r#"Module"#
...
"#;
    ...
    assert!(
        result
            ...
            .iter()
            .any(|item| serde_json::to_value(item).ok().is_some_and(|value| match value {
                serde_json::Value::String(text) => text == r#"os"#,
                serde_json::Value::Object(fields) => fields
                    .get("name")
                    .and_then(serde_json::Value::as_str)
                    .is_some_and(|text| text == r#"os"#),
                _ => false,
            })),
        "expected collection item name: {}",
        r#"os"#
...
"#;
    ...
    assert!(
        result
            ...
            .iter()
            .any(|item| serde_json::to_value(item).ok().is_some_and(|value| match value {
                serde_json::Value::String(text) => text == r#"MyConfig"#,
                serde_json::Value::Object(fields) => fields
                    .get("name")
                    .and_then(serde_json::Value::as_str)
                    .is_some_and(|text| text == r#"MyConfig"#),
                _ => false,
            })),
        "expected collection item name: {}",
        r#"MyConfig"#
