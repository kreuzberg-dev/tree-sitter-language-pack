...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/tree-sitter-language-pack/releases/download/v1.15.7/TreeSitterLanguagePack-rs.artifactbundle.zip",
      checksum: "d823306f4fb790bb317797b749834c8bb02d16212f7cd9c5e3a3dcc331ed6809"
    ),
