...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/tree-sitter-language-pack/releases/download/v1.16.1/TreeSitterLanguagePack-rs.artifactbundle.zip",
      checksum: "99363ec113979dc2ccd11f36bf60fc2fd4d549bd15ff6b773d42bb0610a35eec"
    ),
