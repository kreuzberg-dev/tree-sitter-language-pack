...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/tree-sitter-language-pack/releases/download/v1.15.8/TreeSitterLanguagePack-rs.artifactbundle.zip",
      checksum: "fb18f9ae5ac44e0eb3d638842abc1e5891c93e8fc3e59302f39914eb9507e31c"
    ),
