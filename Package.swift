...
let package = Package(
  ...
  targets: [
    ...
    .binaryTarget(
      ...
      url: "https://github.com/xberg-io/tree-sitter-language-pack/releases/download/v1.16.2/TreeSitterLanguagePack-rs.artifactbundle.zip",
      checksum: "a3615d853a8a661b180afdc3d5e5b6c515de4b13c31c7616c4c11afcfc8784f6"
    ),
