...
// alef:hash:fe61023238a256b6ad984e5dec63cf471e36fee9d75f2fb8ac0908f156024572
...
namespace TreeSitterLanguagePack
{
    ...
    public class LanguageDetectionTests
    {
        ...
        [Fact]    public void Test_DetectContentBashShebang()
        {
    ...
    Assert.Equal("bash", result);
        ...
        [Fact]    public void Test_DetectContentNoShebang()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_DetectContentPythonShebang()
        {
    ...
    Assert.Equal("python", result);
        ...
        [Fact]    public void Test_DetectExtCpp()
        {
    ...
    Assert.Equal("cpp", result);

        }

        [Fact]    public void Test_DetectExtGherkin()
        {
    ...
    Assert.Equal("gherkin", result);

        }

        [Fact]    public void Test_DetectExtGo()
        {
    ...
    Assert.Equal("go", result);
        ...
        [Fact]    public void Test_DetectExtJava()
        {
    ...
    Assert.Equal("java", result);
        ...
        [Fact]    public void Test_DetectExtJavascript()
        {
    ...
    Assert.Equal("javascript", result);
        ...
        [Fact]    public void Test_DetectExtPhp()
        {
    ...
    Assert.Equal("php", result);

        }

        [Fact]    public void Test_DetectExtPython()
        {
    ...
    Assert.Equal("python", result);
        ...
        [Fact]    public void Test_DetectExtRuby()
        {
    ...
    Assert.Equal("ruby", result);
        ...
        [Fact]    public void Test_DetectExtRust()
        {
    ...
    Assert.Equal("rust", result);

        }

        [Fact]    public void Test_DetectExtTypescript()
        {
    ...
    Assert.Equal("typescript", result);
        ...
        [Fact]    public void Test_DetectExtUnknown()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_DetectPathDotfile()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_DetectPathGoNested()
        {
    ...
    Assert.Equal("go", result);
        ...
        [Fact]    public void Test_DetectPathJavaRoot()
        {
    ...
    Assert.Equal("java", result);
        ...
        [Fact]    public void Test_DetectPathJsRoot()
        {
    ...
    Assert.Equal("javascript", result);
        ...
        [Fact]    public void Test_DetectPathNested()
        {
    ...
    Assert.Equal("python", result);
        ...
        [Fact]    public void Test_DetectPathNoExtension()
        {
    ...
    Assert.True(string.IsNullOrEmpty(result?.ToString()));
        ...
        [Fact]    public void Test_DetectPathRustSrc()
        {
