...
// alef:hash:59956834376ff6daaa007c55930abbf95b7569056261c2e19de1d1f7088c81c1
...
namespace TreeSitterLanguagePack
{
    ...
    public class ProcessTests
    {
        ...
        public void Test_CFunctionProcess()
        {
            ...
            Assert.True(result.Structure?.Any(e767d0b15 => Convert.ToString(e767d0b15.Structure[0].Kind)!.Contains("Function")) == true, "element of 'structure[].kind': Function");
        ...
        public void Test_JavaClassProcess()
        {
            ...
            Assert.True(result.Structure.Count >= 1, "expected at least 1 elements");
            Assert.True(result.Structure?.Any(ee876d34e => Convert.ToString(ee876d34e.Structure[0].Kind)!.Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Imports.Count >= 1, "expected at least 1 elements");
            Assert.True(result.Metrics.TotalLines >= 7, "expected >= 7");
            Assert.True(result.Metrics.ErrorCount == 0);
        ...
        public void Test_JavaPackageDeclarationProcess()
        {
            ...
            Assert.True(result.Structure?.Any(e66a77f4c => Convert.ToString(e66a77f4c.Structure[0].Kind)!.Contains("Module")) == true, "element of 'structure[].kind': Module");
            Assert.True(result.Structure?.Any(ee876d34e => Convert.ToString(ee876d34e.Structure[0].Kind)!.Contains("Class")) == true, "element of 'structure[].kind': Class");
            Assert.True(result.Metrics.ErrorCount == 0);
        ...
        public void Test_ProcessPythonImportsDetail()
        {
            ...
            Assert.Equal("python", result.Language);
            Assert.True(result.Imports.Count >= 2, "expected at least 2 elements");
            Assert.True(result.Imports?.Any(e178012aa => Convert.ToString(e178012aa.Imports[0].Source)!.Contains("os")) == true, "element of 'imports[].source': os");
