...
// alef:hash:f30dc7d469334bdf70e7820a39246896a860d5c5ad357b8e5aaa64d437e13c50
...
namespace TreeSitterLanguagePack
{
    ...
    public class ProcessTests
    {
        ...
        [Fact]    public void Test_CFunctionProcess()
        {
    ...
    Assert.Contains("Function", JsonSerializer.Serialize(result.Structure));
    Assert.True(result.Metrics.TotalLines >= 6, "expected >= 6");
    Assert.True(result.Metrics.ErrorCount == 0);

        }

        [Fact]    public void Test_ConfigAllPython()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_ConfigMinimalPython()
        {
    ...
    Assert.True(result.Metrics.TotalLines >= 2, "expected >= 2");
        ...
        [Fact]    public void Test_GoFunctionProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_GoFunctionProcessDetail()
        {
            // Intel: extract structure from Go function definition
            var result = TreeSitterLanguagePackConverter.Process("package main\n\nimport \"fmt\"\n\nfunc main() {\n\tfmt.Println(\"hello\")\n}\n", new ProcessConfig { Language = "go" });
    Assert.Equal("go", result.Language);
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_JavaClassProcess()
        {
    ...
    Assert.True(result.Structure.Count >= 1, "expected at least 1 elements");
    Assert.Contains("Class", JsonSerializer.Serialize(result.Structure));
    Assert.True(result.Imports.Count >= 1, "expected at least 1 elements");
    Assert.True(result.Metrics.TotalLines >= 7, "expected >= 7");
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_JavaPackageDeclarationProcess()
        {
    ...
    Assert.Contains("Module", JsonSerializer.Serialize(result.Structure));
    Assert.Contains("Class", JsonSerializer.Serialize(result.Structure));
    Assert.True(result.Metrics.ErrorCount == 0);

        }

        [Fact]    public void Test_JavascriptMultiImportProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_JavascriptMultiImportProcessDetail()
        {
            // Intel: detect multiple imports and function in JavaScript
            var result = TreeSitterLanguagePackConverter.Process("import fs from 'fs';\nimport path from 'path';\n\nfunction process(input) {\n    return input.trim();\n}\n", new ProcessConfig { Language = "javascript" });
    Assert.Equal("javascript", result.Language);
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_KotlinPackageClassProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_ProcessJavascriptExportsCount()
        {
    ...
    Assert.True(result.Exports.Count >= 2, "expected at least 2 elements");
        ...
        [Fact]    public void Test_ProcessJavascriptExportsDetail()
        {
    ...
    Assert.True(result.Exports.Count >= 1, "expected at least 1 elements");
        ...
        [Fact]    public void Test_ProcessPythonAllFeatures()
        {
    ...
    Assert.True(result.Metrics.TotalLines >= 10, "expected >= 10");
        ...
        [Fact]    public void Test_ProcessPythonComments()
        {
    ...
    Assert.True(result.Comments.Count >= 1, "expected at least 1 elements");
        ...
        [Fact]    public void Test_ProcessPythonDocstrings()
        {
    ...
    Assert.True(result.Metrics.TotalLines >= 3, "expected >= 3");
        ...
        [Fact]    public void Test_ProcessPythonImportsDetail()
        {
            // Python with multiple imports, verify imports contain specific source
            var result = TreeSitterLanguagePackConverter.Process("import os\nimport sys\nfrom pathlib import Path\n\ndef main():\n    pass\n", new ProcessConfig { Language = "python" });
    Assert.Equal("python", result.Language);
    Assert.True(result.Imports.Count >= 2, "expected at least 2 elements");
    Assert.Contains("os", JsonSerializer.Serialize(result.Imports));

        }

        [Fact]    public void Test_ProcessPythonMetricsDetail()
        {
    ...
    Assert.True(result.Metrics.MaxDepth >= 1, "expected >= 1");
        ...
        [Fact]    public void Test_ProcessPythonSymbols()
        {
    ...
    Assert.True(result.Symbols.Count >= 1, "expected at least 1 elements");
        ...
        [Fact]    public void Test_ProcessRustStructureName()
        {
    ...
    Assert.Contains("MyConfig", JsonSerializer.Serialize(result.Structure));
        ...
        [Fact]    public void Test_PythonChunkingMedium()
        {
    ...
    Assert.True(result.Chunks.Count >= 2, "expected at least 2 elements");
        ...
        [Fact]    public void Test_PythonChunkingProcessDetail()
        {
    ...
    Assert.True(result.Chunks.Count >= 2, "expected at least 2 elements");
        ...
        [Fact]    public void Test_PythonClassWithMethodsProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_PythonClassWithMethodsProcessDetail()
        {
            // Intel: extract nested structure from Python class with methods
            var result = TreeSitterLanguagePackConverter.Process("class Calculator:\n    def add(self, a, b):\n        return a + b\n\n    def subtract(self, a, b):\n        return a - b\n", new ProcessConfig { Language = "python" });
    Assert.Equal("python", result.Language);
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_PythonErrorDiagnostics()
        {
    ...
    Assert.True(((object?)result.Diagnostics) switch
            {
                null => false,
        ...
        [Fact]    public void Test_PythonFunctionProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_PythonFunctionProcessDetail()
        {
            // Intel: extract structure from Python function definition
            var result = TreeSitterLanguagePackConverter.Process("def greet(name):\n    return f'Hello, {name}!'\n", new ProcessConfig { Language = "python" });
    Assert.Equal("python", result.Language);
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_PythonMalformedCodeProcess()
        {
    ...
    Assert.True(((object?)result.Diagnostics) switch
        ...
        [Fact]    public void Test_PythonMalformedCodeProcessDetail()
        {
            // Intel: detect diagnostics in malformed Python code
            var result = TreeSitterLanguagePackConverter.Process("def broken(\n    return\nclass", new ProcessConfig { Diagnostics = true, Language = "python" });
    Assert.Equal("python", result.Language);
    Assert.True(((object?)result.Diagnostics) switch
        ...
        [Fact]    public void Test_PythonMultiImportProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_PythonMultiImportProcessDetail()
        {
            // Intel: detect multiple Python imports
            var result = TreeSitterLanguagePackConverter.Process("import os\nimport sys\nfrom pathlib import Path\n\ndef main():\n    pass\n", new ProcessConfig { Language = "python" });
    Assert.Equal("python", result.Language);
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_RubyClassProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_RustChunkingProcess()
        {
    ...
    Assert.True(result.Chunks.Count >= 2, "expected at least 2 elements");
        ...
        [Fact]    public void Test_RustChunkingProcessDetail()
        {
            // Intel: chunk multi-function Rust source into pieces
            var result = TreeSitterLanguagePackConverter.Process("fn alpha() {}\n\nfn beta() {}\n\nfn gamma() {}\n\nfn delta() {}\n", new ProcessConfig { ChunkMaxSize = 30, Language = "rust" });
    Assert.Equal("rust", result.Language);
    ...
    Assert.True(result.Chunks.Count >= 2, "expected at least 2 elements");
        ...
        [Fact]    public void Test_RustFunctionProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_RustFunctionProcessDetail()
        {
            // Intel: extract structure from Rust function definition
            var result = TreeSitterLanguagePackConverter.Process("fn add(a: i32, b: i32) -> i32 {\n    a + b\n}\n", new ProcessConfig { Language = "rust" });
    Assert.Equal("rust", result.Language);
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_TypescriptFunctionProcess()
        {
    ...
    Assert.True(result.Metrics.ErrorCount == 0);
        ...
        [Fact]    public void Test_TypescriptFunctionProcessDetail()
        {
            // Intel: extract structure from TypeScript function
            var result = TreeSitterLanguagePackConverter.Process("import { readFile } from 'fs';\n\nfunction greet(name: string): string {\n    return `Hello, ${name}!`;\n}\n", new ProcessConfig { Language = "typescript" });
    Assert.Equal("typescript", result.Language);
