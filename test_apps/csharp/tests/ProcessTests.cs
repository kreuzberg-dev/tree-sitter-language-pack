...
public class ProcessTests {
  ...
  public void Test_JavaPackageDeclarationProcess() {
    // Intel: Java package declaration emitted as Module so callers can build
    // FQNs (#112)
    var result = TreeSitterLanguagePackConverter.Process(
  ...
  public void Test_KotlinPackageClassProcess() {
    // Intel: Kotlin package header emitted as Module and class name resolved
    // via type_identifier fallback (#111, #112)
    var result = TreeSitterLanguagePackConverter.Process(
        "package foo.bar\n\nclass Widget {\n    fun greet(): String = " +
            "\"hi\"\n}\n",
  ...
  public void Test_ProcessPythonAllFeatures() {
    ...
    var result = TreeSitterLanguagePackConverter.Process(
        ...
        new ProcessConfig { Comments = true, Docstrings = true, Imports = true,
