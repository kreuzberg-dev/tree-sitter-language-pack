...
# alef:hash:748846936c133fc5ea4ada791bd10ccd21857eb4cb51d84f777f9344c255c49e
...
defmodule E2e.ProcessTest do
  ...
  describe "process_with_extractions_map" do
    test "Process: extractions field accepts a Map of ExtractionPattern and returns a Map of PatternResult — exercises the Java/Python/etc. typed-map surface (#115)" do
      ...
      assert String.trim(result.language) == "python"
      assert length(result.extractions.functions.matches) >= 2
