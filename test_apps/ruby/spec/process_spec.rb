...
# alef:hash:60f0a11fc1f0c93f5bb8f8087e1b15203f575a3fbdcc689a4e8a0e0cc2118b70
...
RSpec.describe 'process' do
  ...
  it 'process_with_extractions_map: Process: extractions field accepts a Map of ExtractionPattern and returns a Map of PatternResult — exercises the Java/Python/etc. typed-map surface (#115)' do
    ...
    expect(result.language).to eq('python')
    expect(result.extractions.functions.matches.length).to be >= 2
