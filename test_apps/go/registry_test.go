...
// alef:hash:6922c84e2d3b115dc76b6bacbceef247c2be235cac77a2ca921870e93a961c04
...
func Test_RegistryHasLanguageFalse(t *testing.T) {
	...
	result, err := tspack.HasLanguage(`nonexistent`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RegistryHasLanguageTrue(t *testing.T) {
	...
	result, err := tspack.HasLanguage(`python`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_RegistryLanguageCount(t *testing.T) {
	...
	result, err := tspack.LanguageCount(`{}`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if result < 300 {
...
func Test_RegistryListLanguages(t *testing.T) {
	...
	result, err := tspack.AvailableLanguages(nil)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) == 0 {
