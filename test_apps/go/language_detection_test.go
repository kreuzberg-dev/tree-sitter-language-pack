...
// alef:hash:b988e73bb5fa2a1f170e14750476fae2f34b4abded519e8387aced72aab03e82
...
func Test_DetectContentBashShebang(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromContent(`#!/bin/bash
echo hi`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectContentNoShebang(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromContent(`no shebang here`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
...
func Test_DetectContentPythonShebang(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromContent(`#!/usr/bin/env python3
pass`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtCpp(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`cpp`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtGo(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`go`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtJava(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`java`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtJavascript(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`js`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtPhp(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`php`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtPython(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`py`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(result) != `python` {
...
func Test_DetectExtRuby(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`rb`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtRust(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`rs`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtTypescript(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`ts`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_DetectExtUnknown(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromExtension(`xyz`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
...
func Test_DetectPathDotfile(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`.gitignore`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
...
func Test_DetectPathGoNested(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`lib/server.go`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(result) != `go` {
...
func Test_DetectPathJavaRoot(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`Main.java`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(result) != `java` {
...
func Test_DetectPathJsRoot(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`app.js`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(result) != `javascript` {
...
func Test_DetectPathNested(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`src/main.py`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(result) != `python` {
...
func Test_DetectPathNoExtension(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`Makefile`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
...
func Test_DetectPathRustSrc(t *testing.T) {
	...
	result, err := tspack.DetectLanguageFromPath(`src/main.rs`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if strings.TrimSpace(result) != `rust` {
