...
// alef:hash:dd58d8df6264cd91ee42ebaa135398826cdc3909cabc76459aaf3178cc094712
...
func Test_HighlightsNonexistentLanguage(t *testing.T) {
	...
	result, err := tspack.GetHighlightsQuery(`zzz_nonexistent_lang`)
	if err != nil {
...
func Test_HighlightsQueryPython(t *testing.T) {
	...
	result, err := tspack.GetHighlightsQuery(`python`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) == 0 {
...
func Test_HighlightsQueryUnknownLanguage(t *testing.T) {
	...
	result, err := tspack.GetHighlightsQuery(`nonexistent_language_xyz`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
...
func Test_InjectionsQueryJavascript(t *testing.T) {
	...
	result, err := tspack.GetInjectionsQuery(`javascript`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) == 0 {
...
func Test_InjectionsQueryUnknownLanguage(t *testing.T) {
	...
	result, err := tspack.GetInjectionsQuery(`nonexistent_xyz`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
...
func Test_LocalsQueryPython(t *testing.T) {
	...
	result, err := tspack.GetLocalsQuery(`python`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) == 0 {
...
func Test_LocalsQueryUnknownLanguage(t *testing.T) {
	...
	result, err := tspack.GetLocalsQuery(`nonexistent_xyz`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if len(result) != 0 {
