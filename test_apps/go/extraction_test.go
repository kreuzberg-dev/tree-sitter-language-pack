...
// alef:hash:43a807c503e04c64f44414bc11ca109bad361818faec2e6139609b7e0bb12860
...
func Test_ExtractInvalidByteRange(t *testing.T) {
	...
	result, err := tspack.ExtractPatterns(`x = 1
...
func Test_ExtractPatternsPythonFunctions(t *testing.T) {
	...
	result, err := tspack.ExtractPatterns(`def hello():
    pass
...
func Test_ValidateEmptyPatterns(t *testing.T) {
	...
	result, err := tspack.ValidateExtraction(`{"language":"python","patterns":{}}`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
...
func Test_ValidateExtractionInvalidQuery(t *testing.T) {
	...
	_, err := tspack.ValidateExtraction(`{"language":"python","patterns":{"broken":{"capture_output":"Full","query":"(this_is_not_a_valid_node @x"}}}`)
	if err == nil {
...
func Test_ValidateExtractionValidConfig(t *testing.T) {
	...
	result, err := tspack.ValidateExtraction(`{"language":"python","patterns":{"functions":{"capture_output":"Full","query":"(function_definition name: (identifier) @name)"}}}`)
	if err != nil {
		t.Fatalf("call failed: %v", err)
	}
	if result.Valid != true {
