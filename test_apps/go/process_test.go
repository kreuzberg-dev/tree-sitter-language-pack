...
// alef:hash:43c36386a49e038b0c0a665781f9c869ba444810eba7603c6aedaf5a7ac6f98c
...
`, `{"extractions":{"functions":{"capture_output":"Full","query":"(function_definition name: (identifier) @name)"}},"language":"python"}`)
	...
	assert.GreaterOrEqual(t, len(result.Extractions.Functions.Matches), 2, "expected at least 2 elements")
