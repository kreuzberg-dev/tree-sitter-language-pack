...
// alef:hash:a17922163d1bf1fcab79f93228cb04cec7662f12f41c4acd8accb2af02955917
...
class ProcessTest {
    ...
    @Test
    void testProcessWithExtractionsMap() throws Exception {
        ...
        assertEquals("python", result.language().trim());
        assertTrue(result.extractions().functions().matches().size() >= 2, "expected at least 2 elements");
