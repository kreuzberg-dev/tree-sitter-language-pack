...
// alef:hash:bccf11aa81cca87aff733b9c45aa35accc40800492e838d2c1b75b3b5fcf131a
...
class ParsingTest {
    ...
    @Test
    fun testParsingGoFunction(): Unit = runBlocking {
    ...
    @Test
    fun testParsingHtmlElement(): Unit = runBlocking {
    ...
    @Test
    fun testParsingJavascriptClass(): Unit = runBlocking {
    ...
    @Test
    fun testParsingJavascriptVariable(): Unit = runBlocking {
    ...
    @Test
    fun testParsingPythonFunction(): Unit = runBlocking {
    ...
    @Test
    fun testParsingRustFunction(): Unit = runBlocking {
    ...
    @Test
    fun testParsingRustStruct(): Unit = runBlocking {
    ...
    @Test
    fun testParsingTypescriptFunction(): Unit = runBlocking {
