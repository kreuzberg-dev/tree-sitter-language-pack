...
// alef:hash:2ecd9a7f5042537f2812e9dddb67cbef2616ef3f39493b87e48549e6febcc882
...
final class ProcessTest extends TestCase
{
    ...
    public function test_process_with_extractions_map(): void
    {
        ...
        $this->assertEquals("python", $result->language);
        $this->assertGreaterThanOrEqual(2, count($result->extractions->functions->matches));
