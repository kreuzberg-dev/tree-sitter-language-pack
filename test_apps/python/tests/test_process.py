...
# alef:hash:11348322dc9b8e0cdd20070228695e0ef536cb2ad3500768929b70fb99ee1028
...
def test_process_with_extractions_map() -> None:
    ...
    result = process(source=source, config=config)
    assert result.language.strip() == "python"  # noqa: S101
    assert len(result.extractions.functions.matches) >= 2  # noqa: S101
    assert result.metrics.error_count == 0  # noqa: S101
