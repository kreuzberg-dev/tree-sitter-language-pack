...
// alef:hash:0d06f95ebb6e4649cee6314cc7190708fec71a22232524fd0dfa707430521cce
...
public final class TreeSitterLanguagePackRs {
  ...
  public static List<NodeInfo> findNodesByType(final Tree tree, final String nodeType)
    ...
    try (var arena = Arena.ofConfined()) {
      ...
      return createObjectMapper()
          .readValue(
              json,
              new com.fasterxml.jackson.core.type.TypeReference<java.util.List<NodeInfo>>() {});
    } catch (Throwable e) {
      throw new TreeSitterLanguagePackRsException("FFI call failed", e);
    }
  }
  ...
  public static boolean treeContainsNodeType(final Tree tree, final String nodeType)
    ...
    try (var arena = Arena.ofConfined()) {
      ...
      var cnodeType = arena.allocateFrom(nodeType);
      var primitiveResult =
          (boolean) NativeLib.TS_PACK_TREE_CONTAINS_NODE_TYPE.invoke(ctree, cnodeType);
  ...
  public static List<QueryMatch> runQuery(
    ...
    try (var arena = Arena.ofConfined()) {
      ...
      var resultPtr =
          (MemorySegment)
              NativeLib.TS_PACK_RUN_QUERY.invoke(ctree, clanguage, cquerySource, source);
      if (resultPtr.equals(MemorySegment.NULL)) {
        return java.util.List.of();
      }
      String json = resultPtr.reinterpret(Long.MAX_VALUE).getString(0);
      ...
      return createObjectMapper()
          .readValue(
              json,
              new com.fasterxml.jackson.core.type.TypeReference<java.util.List<QueryMatch>>() {});
    } catch (Throwable e) {
      throw new TreeSitterLanguagePackRsException("FFI call failed", e);
    }
  }
