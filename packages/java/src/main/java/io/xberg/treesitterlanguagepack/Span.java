...
public record Span(@JsonProperty("start_byte") long startByte,
  ...
  public static final class Builder {
    ...
    @JsonProperty("start_byte") private long startByte;
    @JsonProperty("end_byte") private long endByte;
    @JsonProperty("start_line") private long startLine;
    @JsonProperty("start_column") private long startColumn;
    @JsonProperty("end_line") private long endLine;
    @JsonProperty("end_column") private long endColumn;
    ...
    public Span build() {
      return new Span(startByte, endByte, startLine, startColumn, endLine,
                      endColumn);
    }
  }
  // CPD-ON
