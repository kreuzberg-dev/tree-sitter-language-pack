 ...
 * - {@code structure} - Functions, classes, structs (when {@code
 ...
 * - {@code chunks} - Chunked code segments (when {@code config.chunk_max_size}
 * is set)
 */
...
public record ProcessResult(
  ...
  public static final class Builder {
    ...
    public ProcessResult build() {
      return new ProcessResult(language, metrics, structure, imports, exports,
