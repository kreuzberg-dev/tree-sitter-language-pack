 ...
 * NOT add {@code #[serde(tag = "...")]}. Covered by {@code
...
public enum DocstringFormat {
  ...
  DocstringFormat(final String value) { this.value = value; }
  ...
  public static DocstringFormat fromValue(final String value) {
    ...
    throw new IllegalArgumentException("Unknown DocstringFormat value: " +
                                       value);
  }
