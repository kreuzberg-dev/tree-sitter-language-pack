...
public record
StructureItem(@JsonProperty("kind") StructureKind kind,
  ...
  public static final class Builder {
    ...
    @JsonProperty("doc_comment") @Nullable private String docComment;
    @Nullable private String signature;
    @JsonProperty("body_span") @Nullable private Span bodySpan;
    ...
    public StructureItem build() {
      return new StructureItem(kind, name, visibility, span, children,
                               decorators, docComment, signature, bodySpan);
    }
  }
  // CPD-ON
}
