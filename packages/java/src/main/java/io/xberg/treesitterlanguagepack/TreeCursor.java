...
public class TreeCursor implements AutoCloseable {
    ...
    public Node node() throws TreeSitterLanguagePackRsException {
        try {
            ...
            MemorySegment resultPtr = (MemorySegment) NativeLib.TS_PACK_TREE_CURSOR_NODE.invoke(handle());
    ...
    public boolean gotoFirstChild() throws TreeSitterLanguagePackRsException {
        try {
            var result = (long) NativeLib.TS_PACK_TREE_CURSOR_GOTO_FIRST_CHILD.invoke(handle());
            return result != 0;
        } catch (TreeSitterLanguagePackRsException ex) {
            throw ex;
        } catch (Throwable e) {
    ...
    public boolean gotoParent() throws TreeSitterLanguagePackRsException {
        try {
            var result = (long) NativeLib.TS_PACK_TREE_CURSOR_GOTO_PARENT.invoke(handle());
            return result != 0;
        } catch (TreeSitterLanguagePackRsException ex) {
            throw ex;
        } catch (Throwable e) {
    ...
    public boolean gotoNextSibling() throws TreeSitterLanguagePackRsException {
        try {
            var result = (long) NativeLib.TS_PACK_TREE_CURSOR_GOTO_NEXT_SIBLING.invoke(handle());
            return result != 0;
        } catch (TreeSitterLanguagePackRsException ex) {
            throw ex;
        } catch (Throwable e) {
    ...
    public Optional<String> fieldName() throws TreeSitterLanguagePackRsException {
        try {
            MemorySegment resultPtr = (MemorySegment) NativeLib.TS_PACK_TREE_CURSOR_FIELD_NAME.invoke(handle());
            if (resultPtr.equals(MemorySegment.NULL)) {
