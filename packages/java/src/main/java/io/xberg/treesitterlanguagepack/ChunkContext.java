...
public record
ChunkContext(@JsonProperty("language") String language,
  ...
  public static final class Builder {
    ...
    @JsonProperty("has_error_nodes") private boolean hasErrorNodes;
    ...
    public ChunkContext build() {
      return new ChunkContext(language, chunkIndex, totalChunks, nodeTypes,
                              contextPath, symbolsDefined, comments, docstrings,
                              hasErrorNodes);
    }
  }
  // CPD-ON
