...
// alef:hash:de8b675f6137e543c06f3a707ca7905da9acce3189cd47b63565ba4072b197d2
...
public record DataNode(
    ...
    @JsonProperty("attributes") List<DataAttribute> attributes,
    @JsonProperty("children") List<DataNode> children,
    ...
    public static final class Builder {
        ...
        @Nullable private List<DataAttribute> attributes = List.of();
        @Nullable private List<DataNode> children = List.of();
        private Span span;
