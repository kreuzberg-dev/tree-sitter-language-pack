...
// alef:hash:c14053468a00696c01aea9f9e6aecea1f26e3bfa266fdfb7c4e5e6ec2287750e
...
public final class TreeSitterLanguagePackRs {
    ...
    public static String detectLanguageFromExtension(final String ext) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            var primitiveResult = (MemorySegment) NativeLib.TS_PACK_DETECT_LANGUAGE_FROM_EXTENSION.invoke(cext);
    ...
    public static String detectLanguageFromPath(final String path) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            var primitiveResult = (MemorySegment) NativeLib.TS_PACK_DETECT_LANGUAGE_FROM_PATH.invoke(cpath);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static String detectLanguageFromContent(final String content) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            var primitiveResult = (MemorySegment) NativeLib.TS_PACK_DETECT_LANGUAGE_FROM_CONTENT.invoke(ccontent);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static NodeInfo rootNodeInfo(final Tree tree) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_ROOT_NODE_INFO.invoke(ctree);
            if (resultPtr.equals(MemorySegment.NULL)) {
                checkLastError();
                return null;
            }
            var jsonPtr = (MemorySegment) NativeLib.TS_PACK_NODE_INFO_TO_JSON.invoke(resultPtr);
            NativeLib.TS_PACK_NODE_INFO_FREE.invoke(resultPtr);
            ...
            return createObjectMapper().readValue(json, NodeInfo.class);
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    }
    ...
    public static List<NodeInfo> findNodesByType(final Tree tree, final String nodeType) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var cnodeType = arena.allocateFrom(nodeType);
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_FIND_NODES_BY_TYPE.invoke(ctree, cnodeType);
            if (resultPtr.equals(MemorySegment.NULL)) {
                return java.util.List.of();
            }
            String json = resultPtr.reinterpret(Long.MAX_VALUE).getString(0);
            NativeLib.TS_PACK_FREE_STRING.invoke(resultPtr);
            return createObjectMapper().readValue(json, new com.fasterxml.jackson.core.type.TypeReference<java.util.List<NodeInfo>>() { });
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    }
    ...
    public static List<NodeInfo> namedChildrenInfo(final Tree tree) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_NAMED_CHILDREN_INFO.invoke(ctree);
            if (resultPtr.equals(MemorySegment.NULL)) {
                return java.util.List.of();
            }
            String json = resultPtr.reinterpret(Long.MAX_VALUE).getString(0);
    ...
    public static boolean treeContainsNodeType(final Tree tree, final String nodeType) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var cnodeType = arena.allocateFrom(nodeType);
            var primitiveResult = (boolean) NativeLib.TS_PACK_TREE_CONTAINS_NODE_TYPE.invoke(ctree, cnodeType);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static boolean treeHasErrorNodes(final Tree tree) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var primitiveResult = (boolean) NativeLib.TS_PACK_TREE_HAS_ERROR_NODES.invoke(ctree);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static String treeToSexp(final Tree tree) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_TREE_TO_SEXP.invoke(ctree);
            if (resultPtr.equals(MemorySegment.NULL)) {
                checkLastError();
                return null;
            }
    ...
    public static long treeErrorCount(final Tree tree) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var primitiveResult = (long) NativeLib.TS_PACK_TREE_ERROR_COUNT.invoke(ctree);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static String getHighlightsQuery(final String language) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var clanguage = arena.allocateFrom(language);
            var primitiveResult = (MemorySegment) NativeLib.TS_PACK_GET_HIGHLIGHTS_QUERY.invoke(clanguage);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static String getInjectionsQuery(final String language) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var clanguage = arena.allocateFrom(language);
            var primitiveResult = (MemorySegment) NativeLib.TS_PACK_GET_INJECTIONS_QUERY.invoke(clanguage);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static String getLocalsQuery(final String language) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var clanguage = arena.allocateFrom(language);
            var primitiveResult = (MemorySegment) NativeLib.TS_PACK_GET_LOCALS_QUERY.invoke(clanguage);
            return primitiveResult;
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    ...
    public static List<QueryMatch> runQuery(final Tree tree, final String language, final String querySource, final byte[] source) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            var ctree = tree.handle();
            var clanguage = arena.allocateFrom(language);
            var cquerySource = arena.allocateFrom(querySource);
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_RUN_QUERY.invoke(ctree, clanguage, cquerySource, source);
            if (resultPtr.equals(MemorySegment.NULL)) {
                return java.util.List.of();
            }
            String json = resultPtr.reinterpret(Long.MAX_VALUE).getString(0);
            NativeLib.TS_PACK_FREE_STRING.invoke(resultPtr);
            return createObjectMapper().readValue(json, new com.fasterxml.jackson.core.type.TypeReference<java.util.List<QueryMatch>>() { });
        } catch (Throwable e) {
            throw new TreeSitterLanguagePackRsException("FFI call failed", e);
        }
    }
    ...
    public static ExtractionResult extractPatterns(final String source, final ExtractionConfig config) throws TreeSitterLanguagePackRsException {
        try (var arena = Arena.ofConfined()) {
            ...
            var cconfig = cconfigJson != null
                ...
                : MemorySegment.NULL;
            var resultPtr = (MemorySegment) NativeLib.TS_PACK_EXTRACT_PATTERNS.invoke(csource, cconfig);
            if (!cconfig.equals(MemorySegment.NULL)) {
            ...
            var jsonPtr = (MemorySegment) NativeLib.TS_PACK_EXTRACTION_RESULT_TO_JSON.invoke(resultPtr);
            NativeLib.TS_PACK_EXTRACTION_RESULT_FREE.invoke(resultPtr);
            if (jsonPtr.equals(MemorySegment.NULL)) {
                checkLastError();
                return null;
            }
