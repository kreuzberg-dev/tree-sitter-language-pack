...
// alef:hash:ea22db4d5c8964651320d59249c2f3dbc3559c674dbadee37167ca3a1b90eeaa
...
#[rustler::nif]
pub fn processconfig_validate(obj: ProcessConfig) -> Result<(), String> {
    let result = tree_sitter_language_pack::ProcessConfig::from(obj)
        .validate()
        .map_err(|e| e.to_string())?;
    Ok(result)
}
