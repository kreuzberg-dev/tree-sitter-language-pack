...
- `TsPackClient.GetHighlightsQuery(language)` -- get bundled highlights.scm query
- `TsPackClient.GetInjectionsQuery(language)` -- get bundled injections.scm query
- `TsPackClient.GetLocalsQuery(language)` -- get bundled locals.scm query
