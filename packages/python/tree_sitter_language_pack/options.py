...
class Span:
    ...
    """Zero-indexed column of the span's start, counted in **bytes** from the start of the line -- not characters, not UTF-16 code units. ~keep"""
    ...
    """Zero-indexed column of the span's end, counted in **bytes** from the start of the line -- not characters, not UTF-16 code units. ~keep"""
