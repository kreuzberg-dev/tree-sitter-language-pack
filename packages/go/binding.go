...
// }
// ```
func (r *PackConfig) Discover() **string {
    ptr := C.tslp_pack_config_discover (unsafe.Pointer(r), )
    return unmarshalString(ptr)
}


// Default is a method.
func (r *ProcessConfig) Default() *string {
...
func (r *ProcessConfig) WithChunking(max_size uint) *string {
...
func (r *ProcessConfig) All() *string {
...
func (r *ProcessConfig) Minimal() *string {
...
// Default is a method.
func (r *LanguageRegistry) Default() *string {
