...
func (h *Parser) SetMaxSourceBytes(maxBytes *uint) {
	...
	C.ts_pack_parser_set_max_source_bytes((*C.TS_PACKParser)(unsafe.Pointer(h.ptr)), cMaxBytes)
}
...
func (h *Parser) SetParseTimeoutMs(timeoutMs *uint64) {
	...
	C.ts_pack_parser_set_parse_timeout_ms((*C.TS_PACKParser)(unsafe.Pointer(h.ptr)), cTimeoutMs)
}
