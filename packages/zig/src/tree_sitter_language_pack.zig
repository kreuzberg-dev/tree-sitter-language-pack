...
inline fn _from_ffi_msg_Error(msg_opt: ?[]const u8) Error {
    if (msg_opt) |msg| {
        ...
        if (std.mem.startsWith(u8, msg, "Parse cancelled: exceeded the configured budget of")) return error.ParseTimeout;
...
pub const PackConfig = struct {
    ...
    /// An unknown name makes `init` fail. ~keep
...
pub const ProcessConfig = struct {
    ...
    /// whole source; use `null` to mean "do not chunk". ~keep
    chunk_max_size: ?u64,
...
pub const Parser = struct {
    ...
    pub fn set_max_source_bytes(self: *Parser, max_bytes: ?u64) error{HandleClosed}!void {
        ...
        c.ts_pack_parser_set_max_source_bytes(@as(*c.TS_PACKParser, @ptrCast(handle)), if (max_bytes) |v| v else std.math.maxInt(u64));
    }
    ...
    pub fn set_parse_timeout_ms(self: *Parser, timeout_ms: ?u64) error{HandleClosed}!void {
        const handle = self._handle orelse return error.HandleClosed;
        c.ts_pack_parser_set_parse_timeout_ms(@as(*c.TS_PACKParser, @ptrCast(handle)), if (timeout_ms) |v| v else std.math.maxInt(u64));
    }
    ...
    pub fn set_language(self: *Parser, name: []const u8) (Error||error{OutOfMemory,HandleClosed})!void {
        ...
        defer std.heap.c_allocator.free(name_z);
        _ = c.ts_pack_parser_set_language(@as(*c.TS_PACKParser, @ptrCast(handle)), name_z);
        if (c.ts_pack_last_error_code() != 0) {
            return _error_with_message(Error);
        }
    }
    ...
    pub fn parse(self: *Parser, source: []const u8) error{OutOfMemory,HandleClosed}!?Tree {
        ...
        defer std.heap.c_allocator.free(source_z);
        const _result = c.ts_pack_parser_parse(@as(*c.TS_PACKParser, @ptrCast(handle)), source_z);
        return _result;
    }
    ...
    pub fn parse_bytes(self: *Parser, source: []const u8) error{HandleClosed}!?Tree {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_parser_parse_bytes(@as(*c.TS_PACKParser, @ptrCast(handle)), source.ptr, source.len);
        return _result;
    }
    ...
    pub fn reset(self: *Parser) error{HandleClosed}!void {
        const handle = self._handle orelse return error.HandleClosed;
        c.ts_pack_parser_reset(@as(*c.TS_PACKParser, @ptrCast(handle)));
    }
    ...
    pub fn free(self: *Parser) void {
        ...
        self._handle = null;
        c.ts_pack_parser_free(@as(*c.TS_PACKParser, @ptrCast(handle)));
    }
};
...
pub const Tree = struct {
    ...
    pub fn root_node(self: *Tree) error{HandleClosed}!Node {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_root_node(@as(*c.TS_PACKTree, @ptrCast(handle)));
        return Node{ ._handle = _result.? };
    }

    /// Return a `TreeCursor` positioned at the root.
    pub fn walk(self: *Tree) error{HandleClosed}!TreeCursor {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_walk(@as(*c.TS_PACKTree, @ptrCast(handle)));
    ...
    pub fn free(self: *Tree) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.ts_pack_tree_free(@as(*c.TS_PACKTree, @ptrCast(handle)));
    }
};
...
pub const Node = struct {
    ...
    pub fn kind(self: *Node) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_kind(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return blk: {
    ...
    pub fn kind_id(self: *Node) error{HandleClosed}!u16 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_kind_id(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn start_byte(self: *Node) error{HandleClosed}!u64 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_start_byte(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn end_byte(self: *Node) error{HandleClosed}!u64 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_end_byte(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn byte_range(self: *Node) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_byte_range(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return blk: {
    ...
    pub fn start_position(self: *Node) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_start_position(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return blk: {
    ...
    pub fn end_position(self: *Node) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_end_position(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return blk: {
            const _json_ptr = c.ts_pack_point_to_json(_result);
            const _json_slice = std.mem.span(_json_ptr);
            const owned = try std.heap.c_allocator.dupe(u8, _json_slice);
    ...
    pub fn is_named(self: *Node) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_is_named(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn is_error(self: *Node) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_is_error(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn is_missing(self: *Node) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_is_missing(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn is_extra(self: *Node) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_is_extra(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn has_error(self: *Node) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_has_error(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn parent(self: *Node) error{HandleClosed}!?Node {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_parent(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn child(self: *Node, index: u32) error{HandleClosed}!?Node {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_child(@as(*c.TS_PACKNode, @ptrCast(handle)), index);
        return _result;
    }
    ...
    pub fn child_count(self: *Node) error{HandleClosed}!u64 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_child_count(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn named_child(self: *Node, index: u32) error{HandleClosed}!?Node {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_named_child(@as(*c.TS_PACKNode, @ptrCast(handle)), index);
        return _result;
    }
    ...
    pub fn named_child_count(self: *Node) error{HandleClosed}!u64 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_named_child_count(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn child_by_field_name(self: *Node, name: []const u8) error{OutOfMemory,HandleClosed}!?Node {
        ...
        const name_z = try std.heap.c_allocator.dupeZ(u8, name);
        defer std.heap.c_allocator.free(name_z);
        const _result = c.ts_pack_node_child_by_field_name(@as(*c.TS_PACKNode, @ptrCast(handle)), name_z);
        return _result;
    }
    ...
    pub fn to_sexp(self: *Node) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_to_sexp(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return blk: {
            const slice = std.mem.span(_result);
            const owned = try std.heap.c_allocator.dupe(u8, slice);
            c.ts_pack_free_string(_result);
    ...
    pub fn walk(self: *Node) error{HandleClosed}!TreeCursor {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_node_walk(@as(*c.TS_PACKNode, @ptrCast(handle)));
        return TreeCursor{ ._handle = _result.? };
    }
    ...
    pub fn free(self: *Node) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.ts_pack_node_free(@as(*c.TS_PACKNode, @ptrCast(handle)));
    }
};
...
pub const TreeCursor = struct {
    ...
    pub fn node(self: *TreeCursor) error{HandleClosed}!Node {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_cursor_node(@as(*c.TS_PACKTreeCursor, @ptrCast(handle)));
        return Node{ ._handle = _result.? };
    }
    ...
    pub fn goto_first_child(self: *TreeCursor) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_cursor_goto_first_child(@as(*c.TS_PACKTreeCursor, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn goto_parent(self: *TreeCursor) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_cursor_goto_parent(@as(*c.TS_PACKTreeCursor, @ptrCast(handle)));
        return _result != 0;
    }
    ...
    pub fn goto_next_sibling(self: *TreeCursor) error{HandleClosed}!bool {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_cursor_goto_next_sibling(@as(*c.TS_PACKTreeCursor, @ptrCast(handle)));
        return _result != 0;
    }

    /// Return the field name for the current node, if any.
    pub fn field_name(self: *TreeCursor) error{HandleClosed}!?[]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_tree_cursor_field_name(@as(*c.TS_PACKTreeCursor, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn free(self: *TreeCursor) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.ts_pack_tree_cursor_free(@as(*c.TS_PACKTreeCursor, @ptrCast(handle)));
    }
};
...
pub const LanguageRegistry = struct {
    ...
    pub fn get_language(self: *LanguageRegistry, name: []const u8) (Error||error{OutOfMemory,HandleClosed})!Language {
        ...
        const name_z = try std.heap.c_allocator.dupeZ(u8, name);
        defer std.heap.c_allocator.free(name_z);
        const _result = c.ts_pack_language_registry_get_language(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)), name_z);
        if (_result == null) {
            return _first_error(Error);
        }
    ...
    pub fn available_languages(self: *LanguageRegistry) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_language_registry_available_languages(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)));
        return blk: {
            const slice = std.mem.span(_result);
            const owned = try std.heap.c_allocator.dupe(u8, slice);
            c.ts_pack_free_string(_result);
    ...
    pub fn has_parser(self: *LanguageRegistry, name: []const u8) error{OutOfMemory,HandleClosed}!bool {
        ...
        const name_z = try std.heap.c_allocator.dupeZ(u8, name);
        defer std.heap.c_allocator.free(name_z);
        const _result = c.ts_pack_language_registry_has_parser(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)), name_z);
        return _result != 0;
    }
    ...
    pub fn has_language(self: *LanguageRegistry, name: []const u8) error{OutOfMemory,HandleClosed}!bool {
        ...
        const name_z = try std.heap.c_allocator.dupeZ(u8, name);
        defer std.heap.c_allocator.free(name_z);
        const _result = c.ts_pack_language_registry_has_language(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)), name_z);
        return _result != 0;
    }
    ...
    pub fn language_count(self: *LanguageRegistry) error{HandleClosed}!u64 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_language_registry_language_count(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)));
        return _result;
    }
    ...
    pub fn process(self: *LanguageRegistry, source: []const u8, config: []const u8) (Error||error{OutOfMemory,HandleClosed})![]u8 {
        ...
        defer c.ts_pack_process_config_free(config_handle);
        const _result = c.ts_pack_language_registry_process(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)), source_z, config_handle);
        if (_result == null) {
            return _first_error(Error);
        }
        return blk: {
    ...
    pub fn free(self: *LanguageRegistry) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.ts_pack_language_registry_free(@as(*c.TS_PACKLanguageRegistry, @ptrCast(handle)));
    }
};
...
pub const DownloadManager = struct {
    ...
    pub fn installed_languages(self: *DownloadManager) error{OutOfMemory,HandleClosed}![]u8 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_download_manager_installed_languages(@as(*c.TS_PACKDownloadManager, @ptrCast(handle)));
        return blk: {
            const slice = std.mem.span(_result);
            const owned = try std.heap.c_allocator.dupe(u8, slice);
            c.ts_pack_free_string(_result);
    ...
    pub fn download_all_best_effort(self: *DownloadManager) (Error||error{OutOfMemory,HandleClosed})!u64 {
        const handle = self._handle orelse return error.HandleClosed;
        const _result = c.ts_pack_download_manager_download_all_best_effort(@as(*c.TS_PACKDownloadManager, @ptrCast(handle)));
        if (_result == null) {
            return _first_error(Error);
        }
        return _result;
    ...
    pub fn clean_cache(self: *DownloadManager) (Error||error{OutOfMemory,HandleClosed})!void {
        const handle = self._handle orelse return error.HandleClosed;
        _ = c.ts_pack_download_manager_clean_cache(@as(*c.TS_PACKDownloadManager, @ptrCast(handle)));
        if (c.ts_pack_last_error_code() != 0) {
            return _error_with_message(Error);
        }
    }
    ...
    pub fn free(self: *DownloadManager) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.ts_pack_download_manager_free(@as(*c.TS_PACKDownloadManager, @ptrCast(handle)));
    }
};
...
pub const Language = struct {
    ...
    pub fn free(self: *Language) void {
        const handle = self._handle orelse return;
        self._handle = null;
        c.ts_pack_language_free(@as(*c.TS_PACKLanguage, @ptrCast(handle)));
    }
};
