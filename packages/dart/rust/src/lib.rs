...
// alef:hash:b81a332393779916a9fd3c9da3b2fd61a4e1349689a0a824e553491502b94764
...
impl Parser {
    ...
    #[frb]
    pub fn set_max_source_bytes(&mut self, max_bytes: Option<i64>) -> () {
        self.inner.set_max_source_bytes(max_bytes.map(|v| v as usize))
    }
    #[frb]
    pub fn set_parse_timeout_ms(&mut self, timeout_ms: Option<i64>) -> () {
        self.inner.set_parse_timeout_ms(timeout_ms.map(|v| v as u64))
    }
    #[frb]
...
impl From<tree_sitter_language_pack::ProcessConfig> for ProcessConfig {
    fn from(v: tree_sitter_language_pack::ProcessConfig) -> Self {
        ProcessConfig {
            ...
            max_source_bytes: v.max_source_bytes.map(|x| x as _),
            parse_timeout_ms: v.parse_timeout_ms.map(|x| x as _),
        }
    }
}
...
fn try_convert_data_node_kind_from_core(
    value: tree_sitter_language_pack::DataNodeKind,
) -> Result<DataNodeKind, String> {
    let representable = match &value {
        tree_sitter_language_pack::DataNodeKind::KeyValue => true,
        tree_sitter_language_pack::DataNodeKind::Element => true,
        tree_sitter_language_pack::DataNodeKind::Sequence => true,
    };
    if !representable {
        return Err("DataNodeKind contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(DataNodeKind::from(value))
}
...
fn try_convert_structure_kind_from_core(
    value: tree_sitter_language_pack::StructureKind,
) -> Result<StructureKind, String> {
    let representable = match &value {
        tree_sitter_language_pack::StructureKind::Function => true,
        tree_sitter_language_pack::StructureKind::Method => true,
        tree_sitter_language_pack::StructureKind::Class => true,
        tree_sitter_language_pack::StructureKind::Struct => true,
        tree_sitter_language_pack::StructureKind::Interface => true,
        tree_sitter_language_pack::StructureKind::Enum => true,
        tree_sitter_language_pack::StructureKind::Module => true,
        tree_sitter_language_pack::StructureKind::Trait => true,
        tree_sitter_language_pack::StructureKind::Impl => true,
        tree_sitter_language_pack::StructureKind::Namespace => true,
        tree_sitter_language_pack::StructureKind::Other(..) => true,
    };
    if !representable {
        return Err("StructureKind contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(StructureKind::from(value))
}
...
fn try_convert_comment_kind_from_core(value: tree_sitter_language_pack::CommentKind) -> Result<CommentKind, String> {
    let representable = match &value {
        tree_sitter_language_pack::CommentKind::Line => true,
        tree_sitter_language_pack::CommentKind::Block => true,
        tree_sitter_language_pack::CommentKind::Doc => true,
    };
    if !representable {
        return Err("CommentKind contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(CommentKind::from(value))
}
...
fn try_convert_docstring_format_from_core(
    value: tree_sitter_language_pack::DocstringFormat,
) -> Result<DocstringFormat, String> {
    let representable = match &value {
        tree_sitter_language_pack::DocstringFormat::PythonTripleQuote => true,
        tree_sitter_language_pack::DocstringFormat::JSDoc => true,
        tree_sitter_language_pack::DocstringFormat::Rustdoc => true,
        tree_sitter_language_pack::DocstringFormat::GoDoc => true,
        tree_sitter_language_pack::DocstringFormat::JavaDoc => true,
        tree_sitter_language_pack::DocstringFormat::Other(..) => true,
    };
    if !representable {
        return Err("DocstringFormat contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(DocstringFormat::from(value))
}
...
fn try_convert_export_kind_from_core(value: tree_sitter_language_pack::ExportKind) -> Result<ExportKind, String> {
    let representable = match &value {
        tree_sitter_language_pack::ExportKind::Named => true,
        tree_sitter_language_pack::ExportKind::Default => true,
        tree_sitter_language_pack::ExportKind::ReExport => true,
    };
    if !representable {
        return Err("ExportKind contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(ExportKind::from(value))
}
...
fn try_convert_symbol_kind_from_core(value: tree_sitter_language_pack::SymbolKind) -> Result<SymbolKind, String> {
    let representable = match &value {
        tree_sitter_language_pack::SymbolKind::Variable => true,
        tree_sitter_language_pack::SymbolKind::Constant => true,
        tree_sitter_language_pack::SymbolKind::Function => true,
        tree_sitter_language_pack::SymbolKind::Class => true,
        tree_sitter_language_pack::SymbolKind::Type => true,
        tree_sitter_language_pack::SymbolKind::Interface => true,
        tree_sitter_language_pack::SymbolKind::Enum => true,
        tree_sitter_language_pack::SymbolKind::Module => true,
        tree_sitter_language_pack::SymbolKind::Other(..) => true,
    };
    if !representable {
        return Err("SymbolKind contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(SymbolKind::from(value))
}
...
fn try_convert_diagnostic_severity_from_core(
    value: tree_sitter_language_pack::DiagnosticSeverity,
) -> Result<DiagnosticSeverity, String> {
    let representable = match &value {
        tree_sitter_language_pack::DiagnosticSeverity::Error => true,
        tree_sitter_language_pack::DiagnosticSeverity::Warning => true,
        tree_sitter_language_pack::DiagnosticSeverity::Info => true,
    };
    if !representable {
        return Err("DiagnosticSeverity contains a variant unavailable in the Dart binding".to_string());
    }
    Ok(DiagnosticSeverity::from(value))
}
...
pub fn create_data_attribute_from_json(json: String) -> Result<DataAttribute, String> {
    serde_json::from_str::<tree_sitter_language_pack::DataAttribute>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(DataAttribute::from(value)))
}
...
pub fn create_data_node_from_json(json: String) -> Result<DataNode, String> {
    serde_json::from_str::<tree_sitter_language_pack::DataNode>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(DataNode::from(value)))
}
...
pub fn create_span_from_json(json: String) -> Result<Span, String> {
    serde_json::from_str::<tree_sitter_language_pack::Span>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(Span::from(value)))
}
...
pub fn create_process_result_from_json(json: String) -> Result<ProcessResult, String> {
    serde_json::from_str::<tree_sitter_language_pack::ProcessResult>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ProcessResult::from(value)))
}
...
pub fn create_file_metrics_from_json(json: String) -> Result<FileMetrics, String> {
    serde_json::from_str::<tree_sitter_language_pack::FileMetrics>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(FileMetrics::from(value)))
}
...
pub fn create_structure_item_from_json(json: String) -> Result<StructureItem, String> {
    serde_json::from_str::<tree_sitter_language_pack::StructureItem>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(StructureItem::from(value)))
}
...
pub fn create_comment_info_from_json(json: String) -> Result<CommentInfo, String> {
    serde_json::from_str::<tree_sitter_language_pack::CommentInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(CommentInfo::from(value)))
}
...
pub fn create_docstring_info_from_json(json: String) -> Result<DocstringInfo, String> {
    serde_json::from_str::<tree_sitter_language_pack::DocstringInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(DocstringInfo::from(value)))
}
...
pub fn create_doc_section_from_json(json: String) -> Result<DocSection, String> {
    serde_json::from_str::<tree_sitter_language_pack::DocSection>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(DocSection::from(value)))
}
...
pub fn create_import_info_from_json(json: String) -> Result<ImportInfo, String> {
    serde_json::from_str::<tree_sitter_language_pack::ImportInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ImportInfo::from(value)))
}
...
pub fn create_export_info_from_json(json: String) -> Result<ExportInfo, String> {
    serde_json::from_str::<tree_sitter_language_pack::ExportInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ExportInfo::from(value)))
}
...
pub fn create_symbol_info_from_json(json: String) -> Result<SymbolInfo, String> {
    serde_json::from_str::<tree_sitter_language_pack::SymbolInfo>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(SymbolInfo::from(value)))
}
...
pub fn create_diagnostic_from_json(json: String) -> Result<Diagnostic, String> {
    serde_json::from_str::<tree_sitter_language_pack::Diagnostic>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(Diagnostic::from(value)))
}
...
pub fn create_code_chunk_from_json(json: String) -> Result<CodeChunk, String> {
    serde_json::from_str::<tree_sitter_language_pack::CodeChunk>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(CodeChunk::from(value)))
}
...
pub fn create_chunk_context_from_json(json: String) -> Result<ChunkContext, String> {
    serde_json::from_str::<tree_sitter_language_pack::ChunkContext>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ChunkContext::from(value)))
}
...
pub fn create_pack_config_from_json(json: String) -> Result<PackConfig, String> {
    serde_json::from_str::<tree_sitter_language_pack::PackConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(PackConfig::from(value)))
}
...
pub fn create_point_from_json(json: String) -> Result<Point, String> {
    serde_json::from_str::<tree_sitter_language_pack::Point>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(Point::from(value)))
}
...
pub fn create_byte_range_from_json(json: String) -> Result<ByteRange, String> {
    serde_json::from_str::<tree_sitter_language_pack::ByteRange>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ByteRange::from(value)))
}
...
pub fn create_process_config_from_json(json: String) -> Result<ProcessConfig, String> {
    serde_json::from_str::<tree_sitter_language_pack::ProcessConfig>(&json)
        .map_err(|e| e.to_string())
        .and_then(|value| Ok(ProcessConfig::from(value)))
}

#[frb]
pub fn create_data_node_kind_from_json(json: String) -> Result<DataNodeKind, String> {
    serde_json::from_str::<tree_sitter_language_pack::DataNodeKind>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_data_node_kind_from_core)
}

#[frb]
pub fn create_structure_kind_from_json(json: String) -> Result<StructureKind, String> {
    serde_json::from_str::<tree_sitter_language_pack::StructureKind>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_structure_kind_from_core)
}

#[frb]
pub fn create_comment_kind_from_json(json: String) -> Result<CommentKind, String> {
    serde_json::from_str::<tree_sitter_language_pack::CommentKind>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_comment_kind_from_core)
}

#[frb]
pub fn create_docstring_format_from_json(json: String) -> Result<DocstringFormat, String> {
    serde_json::from_str::<tree_sitter_language_pack::DocstringFormat>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_docstring_format_from_core)
}

#[frb]
pub fn create_export_kind_from_json(json: String) -> Result<ExportKind, String> {
    serde_json::from_str::<tree_sitter_language_pack::ExportKind>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_export_kind_from_core)
}

#[frb]
pub fn create_symbol_kind_from_json(json: String) -> Result<SymbolKind, String> {
    serde_json::from_str::<tree_sitter_language_pack::SymbolKind>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_symbol_kind_from_core)
}

#[frb]
pub fn create_diagnostic_severity_from_json(json: String) -> Result<DiagnosticSeverity, String> {
    serde_json::from_str::<tree_sitter_language_pack::DiagnosticSeverity>(&json)
        .map_err(|e| e.to_string())
        .and_then(try_convert_diagnostic_severity_from_core)
}
