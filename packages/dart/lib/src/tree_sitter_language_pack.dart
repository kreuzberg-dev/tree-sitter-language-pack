...
// alef:hash:71ca5a5c2a78722b86f9dff7ec640c9e3622b7bbd3450c3c1859a6f13beeffd4
...
class TreeSitterLanguagePackBridge {
  ...
  static Future<ProcessResult> process(String source, {ProcessConfig? config}) async {
    return await rust_bridge.process(source: source, config: config ?? ProcessConfig(language: '', structure: true, imports: true, exports: true, comments: false, docstrings: false, symbols: false, diagnostics: false, chunkMaxSize: null, dataExtraction: false, maxSourceBytes: null, parseTimeoutMs: null));
  }
  ...
  static Future<void> init({PackConfig? config}) async {
    return await rust_bridge.init(config: config ?? PackConfig(cacheDir: null, languages: null, groups: null));
  }
  ...
  static Future<void> configure({PackConfig? config}) async {
    return await rust_bridge.configure(config: config ?? PackConfig(cacheDir: null, languages: null, groups: null));
  }
  ...
  /// ```
  /// throws Error on failure
  static Future<List<String>> manifestGroups() async {
    return await rust_bridge.manifestGroups();
  }
...
extension DataNodeKindWireValue on DataNodeKind {
  /// The exact serde wire value for this variant.
  String get wireValue {
    switch (this) {
      case DataNodeKind.keyValue:
        return 'KeyValue';
      case DataNodeKind.element:
        return 'Element';
      case DataNodeKind.sequence:
        return 'Sequence';
    }
  }
}

extension CommentKindWireValue on CommentKind {
  /// The exact serde wire value for this variant.
  String get wireValue {
    switch (this) {
...
extension ExportKindWireValue on ExportKind {
  /// The exact serde wire value for this variant.
  String get wireValue {
    switch (this) {
      case ExportKind.named:
        return 'Named';
      case ExportKind.default_:
        return 'Default';
      case ExportKind.reExport:
        return 'ReExport';
    }
  }
}

extension DiagnosticSeverityWireValue on DiagnosticSeverity {
  /// The exact serde wire value for this variant.
  String get wireValue {
    switch (this) {
