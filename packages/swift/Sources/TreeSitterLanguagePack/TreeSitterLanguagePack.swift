...
public struct ProcessConfig: Codable, Sendable, Hashable {
    ...
    public init(language: String, structure: Bool, imports: Bool, exports: Bool, comments: Bool, docstrings: Bool, symbols: Bool, diagnostics: Bool, chunkMaxSize: UInt? = nil, dataExtraction: Bool, maxSourceBytes: UInt? = nil, parseTimeoutMs: UInt64? = nil) {
        self.language = language
