...
// alef:hash:d38a20c395f4bc8450ca17253b1ed506e6c991fb70949c9a9e46e27612e77a5d
...
#[allow(dead_code)]
fn __alef_data_node_kind_from_swift_string(value: &str) -> tree_sitter_language_pack::DataNodeKind {
    match value {
        "KeyValue" => tree_sitter_language_pack::DataNodeKind::KeyValue,
        "Element" => tree_sitter_language_pack::DataNodeKind::Element,
        "Sequence" => tree_sitter_language_pack::DataNodeKind::Sequence,
        _ => panic!("unknown DataNodeKind variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_comment_kind_from_swift_string(value: &str) -> tree_sitter_language_pack::CommentKind {
    match value {
        ...
        _ => panic!("unknown CommentKind variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_export_kind_from_swift_string(value: &str) -> tree_sitter_language_pack::ExportKind {
    match value {
        ...
        _ => panic!("unknown ExportKind variant: {}", value),
    }
}
...
#[allow(dead_code)]
fn __alef_diagnostic_severity_from_swift_string(value: &str) -> tree_sitter_language_pack::DiagnosticSeverity {
    match value {
        ...
        _ => panic!("unknown DiagnosticSeverity variant: {}", value),
    }
}
