...
<!-- alef:hash:7d049e83653aaf56a1d177d1578e22cacd886f70f4ba9b8d6799284de062d81f -->
...
```kotlin
dependencies {
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.15.5")
}
```
