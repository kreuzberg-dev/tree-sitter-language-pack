...
<!-- alef:hash:d6d2b0fcdf200e5ddea1e9c0b4ad7c5d0125af55c49ca0ed2ab83a575575d45d -->
...
```kotlin
dependencies {
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.15.6")
}
```
