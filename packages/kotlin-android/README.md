...
<!-- alef:hash:25546ee45c8e43798f9d36f99dd7707958fd29e4d4cde774ade2c4e9a01a52d1 -->
...
```kotlin
dependencies {
    implementation("io.xberg.tslp.android:tree-sitter-language-pack-android:1.15.3")
}
```
