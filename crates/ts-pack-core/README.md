...
```toml
[dependencies]
ts-pack-core = { version = "2.0.0-alpha.1", default-features = false, features = ["web"] }
```
...
For detailed API documentation, see the [Rust package](https://github.com/Goldziher/tree-sitter-language-pack/tree/main/crates/ts-pack-core).
