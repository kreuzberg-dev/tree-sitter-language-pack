...
// alef:hash:ed73ac1e54dfffba9451ef2774530b6ca257a998df1881ac81b4a8d09b76741d
...
{
    public function __construct(
        /** @var string The kind of structural item. */
        public readonly string $kind,
        /**
...
final class DocstringInfo
{
    public function __construct(
        ...
        public readonly string $text,
        /** @var string The docstring format (Python, JSDoc, Rustdoc, etc.). */
...
final class SymbolInfo
{
    public function __construct(
        ...
        public readonly string $name,
        /** @var string The kind of symbol (variable, function, class, etc.). */
        public readonly string $kind,
...
{
    public const PYTHONTRIPLEQUOTE = 'PythonTripleQuote';
    public const JSDOC = 'JSDoc';
    public const RUSTDOC = 'Rustdoc';
    public const GODOC = 'GoDoc';
    public const JAVADOC = 'JavaDoc';
    public const OTHER = 'Other';
}
