...
// alef:hash:d26653a692eff100338cd09fac9465786f2ea040ac634bb6df80fc4fd00587fa
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.15.2")
