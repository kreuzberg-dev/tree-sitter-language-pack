...
// alef:hash:0ad9f817c1562087f7e2c7e6e143256b7bccdbb69270e917520b14719e13d76b
...
impl ImportInfo {
    ...
    #[php(constructor)]
    pub fn new(source: String, items: Vec<String>, isWildcard: bool, alias: Option<String>) -> Self {
        Self {
            source,
            items,
            alias,
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.15.10")
