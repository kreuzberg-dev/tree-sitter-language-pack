...
// alef:hash:a9845dd60c6e15cbef6305befa0e8d8b1ff5007ff4ddecadacb2f6f2fcea8cd2
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.15.1")
