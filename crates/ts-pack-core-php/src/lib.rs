...
// alef:hash:1227e480b7b5b0cf1f006650e55a829adf5f05afdc29761c08b8e1b10e3f01fe
...
pub extern "C" fn get_module() -> *mut ::ext_php_rs::zend::ModuleEntry {
    ...
    __EXT_PHP_RS_MODULE_ENTRY.get_or_init(|| {
        let builder = ::ext_php_rs::builders::ModuleBuilder::new("tree_sitter_language_pack", "1.15.12")
