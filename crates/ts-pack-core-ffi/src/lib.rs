...
// alef:hash:808cb1e1c1c163ebe6597bf3b92e9777b47bd94ad7cf035a4cfcb365c026f3c1
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_pattern_from_json(
    json: *const c_char,
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_pattern_to_json(
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_pattern_query(
    ptr: *const tree_sitter_language_pack::ExtractionPattern,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_pattern_capture_output(
    ptr: *const tree_sitter_language_pack::ExtractionPattern,
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_pattern_child_fields(
    ptr: *const tree_sitter_language_pack::ExtractionPattern,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_pattern_max_results(
    ptr: *const tree_sitter_language_pack::ExtractionPattern,
) -> usize {
    if ptr.is_null() {
        return 0;
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_config_from_json(
    json: *const c_char,
...
/// The returned string must be freed with `ts_pack_free_string`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_config_to_json(
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_config_language(
    ptr: *const tree_sitter_language_pack::ExtractionConfig,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_config_patterns(
    ptr: *const tree_sitter_language_pack::ExtractionConfig,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
    ...
    // SAFETY: null check above guarantees ptr is a valid pointer.
    let obj = unsafe { &*ptr };
    match serde_json::to_string(&obj.patterns) {
        Ok(s) => match CString::new(s) {
            Ok(cs) => cs.into_raw(),
            Err(_) => std::ptr::null_mut(),
        },
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_capture_result_child_fields(
    ptr: *const tree_sitter_language_pack::CaptureResult,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_result_from_json(
    json: *const c_char,
...
/// The returned string must be freed with `ts_pack_free_string`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_result_to_json(
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_result_language(
    ptr: *const tree_sitter_language_pack::ExtractionResult,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extraction_result_results(
    ptr: *const tree_sitter_language_pack::ExtractionResult,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_validation_result_patterns(
    ptr: *const tree_sitter_language_pack::ValidationResult,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_result_extractions(
    ptr: *const tree_sitter_language_pack::ProcessResult,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
    ...
    // SAFETY: null check above guarantees ptr is a valid pointer.
    let obj = unsafe { &*ptr };
    match serde_json::to_string(&obj.extractions) {
        Ok(s) => match CString::new(s) {
            Ok(cs) => cs.into_raw(),
            Err(_) => std::ptr::null_mut(),
        },
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_from_json(json: *const c_char) -> *mut tree_sitter_language_pack::NodeInfo {
    clear_last_error();
    if json.is_null() {
        set_last_error(1, "Null pointer passed for JSON string");
        return std::ptr::null_mut();
...
/// The returned string must be freed with `ts_pack_free_string`.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_to_json(ptr: *const tree_sitter_language_pack::NodeInfo) -> *mut c_char {
    clear_last_error();
    if ptr.is_null() {
        set_last_error(1, "Null pointer passed to to_json");
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_is_named(ptr: *const tree_sitter_language_pack::NodeInfo) -> i32 {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_start_byte(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_end_byte(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_start_row(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_start_col(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_end_row(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_end_col(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_named_child_count(ptr: *const tree_sitter_language_pack::NodeInfo) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_is_error(ptr: *const tree_sitter_language_pack::NodeInfo) -> i32 {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_node_info_is_missing(ptr: *const tree_sitter_language_pack::NodeInfo) -> i32 {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_extractions(
    ptr: *const tree_sitter_language_pack::ProcessConfig,
) -> *mut std::ffi::c_char {
    if ptr.is_null() {
        return std::ptr::null_mut();
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_query_match_pattern_index(ptr: *const tree_sitter_language_pack::QueryMatch) -> usize {
    if ptr.is_null() {
        return 0;
    }
    // SAFETY: null check above guarantees ptr is a valid pointer.
...
/// Returned pointers must be freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_capture_output_from_i32(value: i32) -> i32 {
    match value {
        0 => 0, // Text
        1 => 1, // Node
        2 => 2, // Full
...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_capture_output_from_str(name: *const c_char) -> i32 {
    if name.is_null() {
...
pub unsafe extern "C" fn ts_pack_find_nodes_by_type(
    ...
    let node_type_rs = match unsafe { CStr::from_ptr(node_type) }.to_str() {
        Ok(s) => s.to_string(),
        Err(_) => {
            set_last_error(1, "Invalid UTF-8 in parameter 'node_type'");
            return std::ptr::null_mut();
        }
    };
    let result = tree_sitter_language_pack::find_nodes_by_type(&tree_rs, &node_type_rs);
    match serde_json::to_string(&result) {
        Ok(s) => match CString::new(s) {
            Ok(cs) => cs.into_raw(),
            Err(_) => std::ptr::null_mut(),
...
pub unsafe extern "C" fn ts_pack_run_query(
    ...
    let query_source_rs = match unsafe { CStr::from_ptr(query_source) }.to_str() {
        Ok(s) => s.to_string(),
        Err(_) => {
            set_last_error(1, "Invalid UTF-8 in parameter 'query_source'");
            return std::ptr::null_mut();
        }
    };
    if source.is_null() {
...
/// Returned pointers must be freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_extract_patterns(
    source: *const std::ffi::c_char,
