...
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_parser_set_max_source_bytes(
    ...
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let result = obj.set_max_source_bytes(max_bytes_rs);
    })) {
        Ok(value) => value,
        Err(_) => {
            let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(set_panic_error));
...
/// freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_parser_set_parse_timeout_ms(
    this: *mut tree_sitter_language_pack::Parser,
    timeout_ms: u64,
) {
    clear_last_error();
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        ...
        let result = obj.set_parse_timeout_ms(timeout_ms_rs);
    })) {
        Ok(value) => value,
        Err(_) => {
            let _ = std::panic::catch_unwind(std::panic::AssertUnwindSafe(set_panic_error));
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_max_source_bytes(
    ptr: *const tree_sitter_language_pack::ProcessConfig,
) -> usize {
    catch_ffi_panic(0, || {
        if ptr.is_null() {
...
/// Pointer must be a valid handle returned by this library.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_parse_timeout_ms(
    ptr: *const tree_sitter_language_pack::ProcessConfig,
) -> u64 {
    catch_ffi_panic(0, || {
        if ptr.is_null() {
...
/// freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_with_parse_timeout_ms(
    this: *mut tree_sitter_language_pack::ProcessConfig,
    timeout_ms: u64,
) -> *mut tree_sitter_language_pack::ProcessConfig {
    clear_last_error();
...
/// freed with the appropriate free function.
#[unsafe(no_mangle)]
pub unsafe extern "C" fn ts_pack_process_config_validate(this: *const tree_sitter_language_pack::ProcessConfig) -> i32 {
    clear_last_error();
    match std::panic::catch_unwind(std::panic::AssertUnwindSafe(|| {
        if this.is_null() {
            set_last_error(1, "Null pointer passed for self");
