...
// alef:hash:904c46823a730d2b8b3cd2726956ad4756c5187a6d36c56df0486578acc602ea
...
impl WasmExtractionConfig {
    #[wasm_bindgen(constructor)]
    pub fn new(language: Option<String>, patterns: Option<JsValue>) -> WasmExtractionConfig {
    ...
    #[wasm_bindgen(setter)]
    pub fn set_patterns(&mut self, value: JsValue) {
        self.patterns = value;
    }
}
...
impl WasmCaptureResult {
    ...
    #[wasm_bindgen(getter, js_name = "childFields")]
    pub fn child_fields(&self) -> JsValue {
        self.child_fields.clone()
    }

    #[wasm_bindgen(setter, js_name = "childFields")]
    pub fn set_child_fields(&mut self, value: JsValue) {
        self.child_fields = value;
    }
...
impl WasmExtractionResult {
    #[wasm_bindgen(constructor)]
    pub fn new(language: Option<String>, results: Option<JsValue>) -> WasmExtractionResult {
    ...
    #[wasm_bindgen(setter)]
    pub fn set_results(&mut self, value: JsValue) {
        self.results = value;
    }
}
...
impl WasmValidationResult {
    #[wasm_bindgen(constructor)]
    pub fn new(valid: Option<bool>, patterns: Option<JsValue>) -> WasmValidationResult {
...
impl WasmProcessResult {
    ...
    #[wasm_bindgen(getter)]
    pub fn extractions(&self) -> JsValue {
        self.extractions.clone()
    }

    #[wasm_bindgen(setter)]
    pub fn set_extractions(&mut self, value: JsValue) {
...
impl WasmProcessConfig {
    ...
    #[wasm_bindgen(getter)]
    pub fn extractions(&self) -> Option<JsValue> {
        self.extractions.clone()
    }

    #[wasm_bindgen(setter)]
    pub fn set_extractions(&mut self, value: Option<JsValue>) {
        self.extractions = value;
    }
...
impl From<WasmExtractionPattern> for tree_sitter_language_pack::ExtractionPattern {
    fn from(val: WasmExtractionPattern) -> Self {
        Self {
            query: val.query,
...
impl From<WasmExtractionConfig> for tree_sitter_language_pack::ExtractionConfig {
    fn from(val: WasmExtractionConfig) -> Self {
        Self {
            ...
            patterns: serde_wasm_bindgen::from_value(val.patterns.clone()).unwrap_or_default(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ExtractionConfig> for WasmExtractionConfig {
    fn from(val: tree_sitter_language_pack::ExtractionConfig) -> Self {
        Self {
            language: val.language,
            patterns: serde_wasm_bindgen::to_value(&val.patterns).unwrap_or(JsValue::NULL),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmCaptureResult> for tree_sitter_language_pack::CaptureResult {
    fn from(val: WasmCaptureResult) -> Self {
        Self {
            name: val.name,
            node: val.node.map(Into::into),
            text: val.text,
            child_fields: serde_wasm_bindgen::from_value(val.child_fields.clone()).unwrap_or_default(),
...
impl From<tree_sitter_language_pack::CaptureResult> for WasmCaptureResult {
    fn from(val: tree_sitter_language_pack::CaptureResult) -> Self {
        Self {
            ...
            node: val.node.map(Into::into),
            text: val.text,
            child_fields: serde_wasm_bindgen::to_value(&val.child_fields).unwrap_or(JsValue::NULL),
            start_byte: val.start_byte,
        }
    }
}
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmMatchResult> for tree_sitter_language_pack::MatchResult {
    fn from(val: WasmMatchResult) -> Self {
        Self {
...
#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmPatternResult> for tree_sitter_language_pack::PatternResult {
    fn from(val: WasmPatternResult) -> Self {
        Self {
...
impl From<WasmExtractionResult> for tree_sitter_language_pack::ExtractionResult {
    fn from(val: WasmExtractionResult) -> Self {
        Self {
            language: val.language,
            results: serde_wasm_bindgen::from_value(val.results.clone()).unwrap_or_default(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ExtractionResult> for WasmExtractionResult {
    fn from(val: tree_sitter_language_pack::ExtractionResult) -> Self {
        Self {
            language: val.language,
            results: serde_wasm_bindgen::to_value(&val.results).unwrap_or(JsValue::NULL),
        }
    }
}

#[allow(clippy::redundant_closure, clippy::useless_conversion)]
impl From<WasmPatternValidation> for tree_sitter_language_pack::PatternValidation {
    fn from(val: WasmPatternValidation) -> Self {
        Self {
            valid: val.valid,
...
impl From<WasmProcessResult> for tree_sitter_language_pack::ProcessResult {
    fn from(val: WasmProcessResult) -> Self {
        Self {
            ...
            extractions: serde_wasm_bindgen::from_value(val.extractions.clone()).unwrap_or_default(),
        }
    }
}
...
impl From<tree_sitter_language_pack::ProcessResult> for WasmProcessResult {
    fn from(val: tree_sitter_language_pack::ProcessResult) -> Self {
        Self {
            ...
            diagnostics: val.diagnostics.into_iter().map(Into::into).collect(),
            chunks: val.chunks.into_iter().map(Into::into).collect(),
            extractions: serde_wasm_bindgen::to_value(&val.extractions).unwrap_or(JsValue::NULL),
        }
    }
}
...
impl From<WasmCaptureOutput> for tree_sitter_language_pack::CaptureOutput {
    fn from(val: WasmCaptureOutput) -> Self {
        match val {
            WasmCaptureOutput::Text => Self::Text,
            WasmCaptureOutput::Node => Self::Node,
            WasmCaptureOutput::Full => Self::Full,
        }
    }
}
