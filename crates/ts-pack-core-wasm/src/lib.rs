...
// alef:hash:ea06ad6585bd77efe331c7bb80a69dcc68a9cb4b003df8ba886fa647adc0e7ff
...
impl WasmStructureItem {
    ...
    pub fn new(
        ...
        WasmStructureItem {
            kind: kind.unwrap_or_else(|| {
                <tree_sitter_language_pack::StructureItem as ::core::default::Default>::default()
                    .kind
                    .into()
            }),
            name: name,
    ...
    pub fn new(
        ...
        WasmDocstringInfo {
            ...
            format: format.unwrap_or_else(|| {
                <tree_sitter_language_pack::DocstringInfo as ::core::default::Default>::default()
                    .format
                    .into()
            }),
            span: span.unwrap_or_default(),
...
impl WasmSymbolInfo {
    ...
    pub fn new(
        ...
        WasmSymbolInfo {
            name: name.unwrap_or_default(),
            kind: kind.unwrap_or_else(|| {
                <tree_sitter_language_pack::SymbolInfo as ::core::default::Default>::default()
                    .kind
                    .into()
            }),
            span: span.unwrap_or_default(),
