...
// alef:hash:bcead1384c316bbe5686f4c2dbafbdc5cdf7966bbd0b7984c77695813d661ae5
...
export interface JsCaptureResult {
  ...
  childFields: Record<string, string | undefined | null>
...
export interface JsExtractionConfig {
  ...
  patterns: Record<string, JsExtractionPattern>
}
...
export interface JsExtractionResult {
  ...
  results: Record<string, JsPatternResult>
}
...
export interface JsProcessConfig {
   ...
   */
  extractions: Record<string, JsExtractionPattern>
}
...
export interface JsProcessResult {
  ...
  extractions: Record<string, JsPatternResult>
}
...
export interface JsValidationResult {
  ...
  patterns: Record<string, JsPatternValidation>
}
