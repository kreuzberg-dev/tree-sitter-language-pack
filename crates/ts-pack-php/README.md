...
- `detect_language_from_extension(ext)` -- detect language from a bare file extension (without leading dot)
- `detect_language_from_path(path)` -- detect language from a file path based on its extension
