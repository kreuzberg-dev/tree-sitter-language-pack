...
Build from source as part of the [tree-sitter-language-pack](https://github.com/Goldziher/tree-sitter-language-pack) workspace.
...
For detailed API documentation, see the [C/C++ (FFI) package](https://github.com/Goldziher/tree-sitter-language-pack/tree/main/crates/ts-pack-ffi).
