...
import (
    "fmt"
    tspack "github.com/Goldziher/tree-sitter-language-pack/go"
)
...
For detailed API documentation, see the [Go package](https://github.com/Goldziher/tree-sitter-language-pack/tree/main/crates/ts-pack-go).
